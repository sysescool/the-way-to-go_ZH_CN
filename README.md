...
这是 sysescool 从 [the-way-to-go_ZH_CN](https://github.com/unknwon/the-way-to-go_ZH_CN) 分叉的 repo。

看起来原作者 unknwon 已经不再维护了。

如果发现任何错误，请发送 pull&request 到 master_sysescool 分支。

This repo forked from [the-way-to-go_ZH_CN](https://github.com/unknwon/the-way-to-go_ZH_CN).

And it's seems like the user unknwon won't maintain him repo.

master branch is source repo master branch.
...
21.5 [总结和增强](eBook/21.5.md) by [loftea](https://github.com/unknwon/the-way-to-go_ZH_CN/pull/831)
...
- 参与翻译人员：
	...
	- [@loftea](https://github.com/loftea)
